...
<html>
	...
	<body>
        <?php
            ...
            // Crear la conexión
			$servername = "mysql";  // Nombre del servicio en docker-compose
			$database = "if0_38346359_dwes";  // Debe coincidir con MYSQL_DATABASE
			$username = "if0_38346359";  // Debe coincidir con MYSQL_USER
			$password = "m6hdATxi5C";  // Debe coincidir con MYSQL_PASSWORD
